...
from grim_dawn_sync.selection import CancelledSelection, ReconcileCase, SelectionDirective, SelectionMode, SelectionPlan, SelectionRegistry
        ...
        def populate(catalog: VersionCatalog) -> None:
            ...
            def choose(mode: SelectionMode) -> None:
                ...
                result = SelectionRequest(item.candidate_id, mode, name_var.get() or None, note_var.get() or None,
                                          confirmation_granted=confirmed); close()
